    ...
    <div className="inforstaff">
      <div className="inforstaff__top">
        <div className="box-staff">
          <img priority={true} src="/staff1.svg" alt="" />
          <Staffname
        ...
        <div className="box-staff">
          ...
          ></Staffname>
          <img priority={true} src="/staff2.svg" alt="" />
        </div>
      </div>
      <div className="inforstaff__bot">
        <div className="box-staff2">
          <div className="box-staff">
            <img priority={true} src="/staff3.svg" alt="" />
            <Staffname
          ...
          <div className="box-staff">
            <img priority={true} src="/staff4.svg" alt="" />
            <Staffname
        ...
        <div className="box-staff2">
          <div className="box-staff">
            <img priority={true} src="/staff5.svg" alt="" />
            <Staffname
          ...
          <div className="box-staff">
            <img priority={true} src="/staff6.svg" alt="" />
            <Staffname
